...
if timePassed == 0:
  print("Wow! That means Cybersecurity will begin this year, " + str(cybersecurityBirthYear) + "!")

elif timePassed < 0:
  print("Wow! That means Cybersecurity will begin in " + str(abs(timePassed)) + " years!")
